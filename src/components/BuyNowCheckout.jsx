    ...
    if (file) {
      ...
      if (file.size > MAX_FILE_SIZE) {
        if (type === 'online') {
          ...
          setErrors(prev => ({ ...prev, codDeliveryProof: 'File size exceeds 5MB limit.' }));
          setCodDeliveryProofBase64(null);
        }
        return;
      }
                ...
                <div className="mt-6 p-4 border border-amber-300 bg-amber-50 rounded-md">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-2 border ${errors.codDeliveryProof ? 'border-red-500' : 'border-gray-300'} rounded-md focus:ring-black focus:border-black text-sm sm:text-base`}
                    />
